...
## Keys
We can do a "primary key" in data.table - this allows us to faster indexing but doesn't have a uniqueness constraint and a .

To set the key explicitly:

```{r}
setkey(irisDT, Species)
setindex(irisDT, Species)
```

Howerver, we don't often need to do this these days!
