...
knitr::opts_chunk$set( message = FALSE, results='hide', dev="svg",
...
```{r xyc, fig.cap="Simple line of best fit"}
set.seed(777)
...
```{r rbinom, fig.cap="Binomial outcome variable"}
...
```{r probs, fig.cap="Probability range, where dashed line indicates 50% probability cutoff"}
...
```{r oddsdist, fig.cap="Odds distribution"}
