 ...
 * Install
 * Install the client from [](https://msysgit.github.io/)
 ...
 * Use Packages > Install to install devtools and installr (this can take a while due to dependencies)
 
## Rtraining
 * Install Rtraining (this can take a while due to dependencies, as I want you to have the most commonly used packages) by executing
```r
# Case-sensitive!
